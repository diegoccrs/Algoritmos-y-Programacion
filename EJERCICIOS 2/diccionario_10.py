...
while opcion != "6":
    if opcion == "1":
        ...
        telefono = input("Introduce el numero de telefono del cliente: ")
        email = input("Introduce el correo electronico del cliente: ")
        preferente = input("¿Es un cliente preferente? (S/N)")
        cliente = {"Nombre":nombre,"Direccion":direccion,"Telefono":telefono,"Correo":email,"Preferente":preferente=="S"}
